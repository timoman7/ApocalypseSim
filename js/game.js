...
firebase.auth().getRedirectResult().then(function(result) {
  ...
  var credential = result.credential;
	if(user===null){
		...
		signOutButton.style = "position: inherit; right: 10px; bottom: 10px; width: 60px; height: 30px; border-radius: 4px; border-style: ridge; border-color: black; color: grey;";
		...
		userInfo1.style="position: absolute; left: 10px; top: 10px; font-size: 12px; color: black;";
		userInfo2.style="position: absolute; left: 10px; top: 22px; font-size: 12px; color: black;";
		userIcon.src=currentUser.photoURL;
		userIcon.style="position: inherit; right: 10px; top 10px; width: 120px; height: 120px; border-radius: 60px;";
